...
begin
	 ...
	 ELSE Begin
         ...
         THEN Begin
               ...
               THEN Begin
                  IF Not ArmedForOpen
                  THEN WITH ActiveCircuit[ActiveActor] Do   // Then arm for an open operation
                  Begin
               ...
               ELSE Begin
                   IF ArmedForOpen
                   THEN  WITH ActiveCircuit[ActiveActor] Do    // If current dropped below pickup, disarm trip and set for reset
                   Begin
