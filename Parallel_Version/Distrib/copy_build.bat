...
xcopy /d /s /y Examples\*.bat installer\Examples
xcopy /d /s /y Examples\*.csv installer\Examples
...
xcopy /d /s /y Examples\*.pdf installer\Examples
xcopy /d /s /y Examples\*.ppt installer\Examples
xcopy /d /s /y Examples\*.py  installer\Examples
xcopy /d /s /y Examples\*.txt installer\Examples
xcopy /d /s /y Examples\*.xls installer\Examples
xcopy /d /s /y Examples\*.zip installer\Examples
...
xcopy /d /s /y IEEETestCases\*.dat installer\IEEETestCases
