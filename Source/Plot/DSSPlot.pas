...
begin
   ...
   If MakeNewGraph(DSSDataDirectory + CircuitName_ + 'DIPlot.DSV') = 0 Then
   Begin
...
begin
   ...
   If MakeNewGraph(DSSDataDirectory + CircuitName_ + 'CompPlot.DSV')=0
   Then Begin
...
begin
   ...
   If MakeNewGraph(DSSDataDirectory + CircuitName_ + 'YearlyPlot.DSV')=0
   Then Begin
