...
java -classpath ".:/Users/mcde601/src/apache-jena-3.1.0/lib/*:/Users/mcde601/src/commons-math3-3.6.1/*" CDPSM_to_GLM -t=y -e=u -f=60 -v=1 -s=1 -q=y ieee13.xml ieee13
java -classpath ".:/Users/mcde601/src/apache-jena-3.1.0/lib/*:/Users/mcde601/src/commons-math3-3.6.1/*" CDPSM_to_GLM -t=y -e=u -f=60 -v=1 -s=1 -q=y ieee13_assets.xml ieee13_assets
java -classpath ".:/Users/mcde601/src/apache-jena-3.1.0/lib/*:/Users/mcde601/src/commons-math3-3.6.1/*" CDPSM_to_GLM -t=y -e=u -f=60 -v=1 -s=1 -q=y ieee8500.xml ieee8500
java -classpath ".:/Users/mcde601/src/apache-jena-3.1.0/lib/*:/Users/mcde601/src/commons-math3-3.6.1/*" CDPSM_to_GLM -t=n -e=u -f=60 -v=1 -s=1 -q=y ieee8500.xml ieee8500p
java -classpath ".:/Users/mcde601/src/apache-jena-3.1.0/lib/*:/Users/mcde601/src/commons-math3-3.6.1/*" CDPSM_to_GLM -t=y -e=u -f=60 -v=1 -s=1 -q=y ieee8500u.xml ieee8500u
